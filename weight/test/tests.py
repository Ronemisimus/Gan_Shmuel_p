...
def main():
    test_health()
    test_get_routes('/unknown' ,{"7":{"ContainerID":"C1","Produce":"Test","TransactionID":"36"},"8":{"ContainerID":"C1","Produce":"Banana","TransactionID":"37"},"9":{"ContainerID":"C1","Produce":"Peaches","TransactionID":"37"}})
